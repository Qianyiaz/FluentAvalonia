...
internal readonly unsafe struct HINSTANCE : IComparable, IEquatable<HINSTANCE>
{
    ...
    public static HINSTANCE INVALID_VALUE => new((void*)-1);

    public static HINSTANCE NULL => new(null);
    ...
    public static explicit operator HINSTANCE(byte value) => new((void*)value);

    public static explicit operator byte(HINSTANCE value) => (byte)value.Value;

    public static explicit operator HINSTANCE(short value) => new((void*)value);

    public static explicit operator short(HINSTANCE value) => (short)value.Value;

    public static explicit operator HINSTANCE(int value) => new((void*)value);

    public static explicit operator int(HINSTANCE value) => (int)value.Value;

    public static explicit operator HINSTANCE(long value) => new((void*)value);

    public static explicit operator long(HINSTANCE value) => (long)value.Value;

    public static explicit operator HINSTANCE(nint value) => new((void*)value);

    public static implicit operator nint(HINSTANCE value) => (nint)value.Value;

    public static explicit operator HINSTANCE(sbyte value) => new((void*)value);

    public static explicit operator sbyte(HINSTANCE value) => (sbyte)value.Value;

    public static explicit operator HINSTANCE(ushort value) => new((void*)value);

    public static explicit operator ushort(HINSTANCE value) => (ushort)value.Value;

    public static explicit operator HINSTANCE(uint value) => new((void*)value);

    public static explicit operator uint(HINSTANCE value) => (uint)value.Value;

    public static explicit operator HINSTANCE(ulong value) => new((void*)value);

    public static explicit operator ulong(HINSTANCE value) => (ulong)value.Value;

    public static explicit operator HINSTANCE(nuint value) => new((void*)value);

    public static implicit operator nuint(HINSTANCE value) => (nuint)value.Value;

    public int CompareTo(object obj)
    {
        if (obj is HINSTANCE other) return CompareTo(other);
