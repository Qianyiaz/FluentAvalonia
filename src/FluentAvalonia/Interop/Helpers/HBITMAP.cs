...
internal readonly unsafe struct HBITMAP : IComparable, IEquatable<HBITMAP>
{
    ...
    public static HBITMAP INVALID_VALUE => new((void*)-1);

    public static HBITMAP NULL => new(null);
    ...
    public static explicit operator HBITMAP(void* value) => new(value);

    public static implicit operator void*(HBITMAP value) => value.Value;

    public static explicit operator HBITMAP(byte value) => new((void*)value);

    public static explicit operator byte(HBITMAP value) => (byte)value.Value;

    public static explicit operator HBITMAP(short value) => new((void*)value);

    public static explicit operator short(HBITMAP value) => (short)value.Value;

    public static explicit operator HBITMAP(int value) => new((void*)value);

    public static explicit operator int(HBITMAP value) => (int)value.Value;

    public static explicit operator HBITMAP(long value) => new((void*)value);

    public static explicit operator long(HBITMAP value) => (long)value.Value;

    public static explicit operator HBITMAP(nint value) => new((void*)value);

    public static implicit operator nint(HBITMAP value) => (nint)value.Value;

    public static explicit operator HBITMAP(sbyte value) => new((void*)value);

    public static explicit operator sbyte(HBITMAP value) => (sbyte)value.Value;

    public static explicit operator HBITMAP(ushort value) => new((void*)value);

    public static explicit operator ushort(HBITMAP value) => (ushort)value.Value;

    public static explicit operator HBITMAP(uint value) => new((void*)value);

    public static explicit operator uint(HBITMAP value) => (uint)value.Value;

    public static explicit operator HBITMAP(ulong value) => new((void*)value);

    public static explicit operator ulong(HBITMAP value) => (ulong)value.Value;

    public static explicit operator HBITMAP(nuint value) => new((void*)value);

    public static implicit operator nuint(HBITMAP value) => (nuint)value.Value;

    public int CompareTo(object obj)
    {
        if (obj is HBITMAP other) return CompareTo(other);
