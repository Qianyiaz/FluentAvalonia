...
internal readonly unsafe struct WPARAM : IComparable, IEquatable<WPARAM>
{
    ...
    public static implicit operator WPARAM(byte value) => new(value);

    public static explicit operator byte(WPARAM value) => (byte)value.Value;

    public static explicit operator WPARAM(short value) => new((nuint)value);
    ...
    public static explicit operator WPARAM(long value) => new((nuint)value);

    public static explicit operator long(WPARAM value) => (long)value.Value;

    public static explicit operator WPARAM(nint value) => new((nuint)value);

    public static explicit operator nint(WPARAM value) => (nint)value.Value;

    public static explicit operator WPARAM(sbyte value) => new((nuint)value);

    public static explicit operator sbyte(WPARAM value) => (sbyte)value.Value;

    public static implicit operator WPARAM(ushort value) => new(value);
    ...
    public static explicit operator WPARAM(ulong value) => new((nuint)value);
    ...
    {
        if (obj is WPARAM other) return CompareTo(other);
    ...
    public static explicit operator WPARAM(void* value) => new((nuint)value);

    public static implicit operator void*(WPARAM value) => (void*)value.Value;

    public static explicit operator WPARAM(BOOL value) => new((nuint)value.Value);

    public static explicit operator BOOL(WPARAM value) => new((int)value.Value);
    ...
    public static explicit operator WPARAM(HMENU value) => new((nuint)value.Value);

    public static explicit operator HMENU(WPARAM value) => new((void*)value.Value);
    ...
    public static explicit operator HWND(WPARAM value) => new((void*)value.Value);

    public static explicit operator WPARAM(LPARAM value) => new((nuint)value.Value);

    public static explicit operator WPARAM(LRESULT value) => new((nuint)value.Value);
}