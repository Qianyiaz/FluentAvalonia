...
internal readonly unsafe struct HMENU : IComparable, IEquatable<HMENU>
{
    ...
    public static HMENU INVALID_VALUE => new((void*)-1);

    public static HMENU NULL => new(null);
    ...
    public static explicit operator HMENU(byte value) => new((void*)value);

    public static explicit operator byte(HMENU value) => (byte)value.Value;

    public static explicit operator HMENU(short value) => new((void*)value);

    public static explicit operator short(HMENU value) => (short)value.Value;

    public static explicit operator HMENU(int value) => new((void*)value);

    public static explicit operator int(HMENU value) => (int)value.Value;

    public static explicit operator HMENU(long value) => new((void*)value);

    public static explicit operator long(HMENU value) => (long)value.Value;

    public static explicit operator HMENU(nint value) => new((void*)value);

    public static implicit operator nint(HMENU value) => (nint)value.Value;

    public static explicit operator HMENU(sbyte value) => new((void*)value);

    public static explicit operator sbyte(HMENU value) => (sbyte)value.Value;

    public static explicit operator HMENU(ushort value) => new((void*)value);

    public static explicit operator ushort(HMENU value) => (ushort)value.Value;

    public static explicit operator HMENU(uint value) => new((void*)value);

    public static explicit operator uint(HMENU value) => (uint)value.Value;

    public static explicit operator HMENU(ulong value) => new((void*)value);

    public static explicit operator ulong(HMENU value) => (ulong)value.Value;

    public static explicit operator HMENU(nuint value) => new((void*)value);

    public static implicit operator nuint(HMENU value) => (nuint)value.Value;

    public int CompareTo(object obj)
    {
        if (obj is HMENU other) return CompareTo(other);
