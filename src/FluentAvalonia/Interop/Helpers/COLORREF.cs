...
internal readonly struct COLORREF : IComparable, IComparable<COLORREF>, IEquatable<COLORREF>, IFormattable
{
    ...
    public static implicit operator COLORREF(byte value) => new(value);

    public static explicit operator byte(COLORREF value) => (byte)value.Value;

    public static explicit operator COLORREF(short value) => new((uint)value);

    public static explicit operator short(COLORREF value) => (short)value.Value;

    public static explicit operator COLORREF(int value) => new((uint)value);

    public static explicit operator int(COLORREF value) => (int)value.Value;

    public static explicit operator COLORREF(long value) => new((uint)value);

    public static implicit operator long(COLORREF value) => value.Value;

    public static explicit operator COLORREF(nint value) => new((uint)value);

    public static explicit operator nint(COLORREF value) => (nint)value.Value;

    public static explicit operator COLORREF(sbyte value) => new((uint)value);

    public static explicit operator sbyte(COLORREF value) => (sbyte)value.Value;

    public static implicit operator COLORREF(ushort value) => new(value);
    ...
    public static explicit operator COLORREF(ulong value) => new((uint)value);

    public static implicit operator ulong(COLORREF value) => value.Value;

    public static explicit operator COLORREF(nuint value) => new((uint)value);

    public static implicit operator nuint(COLORREF value) => value.Value;

    public int CompareTo(object obj)
    {
        if (obj is COLORREF other) return CompareTo(other);
