...
[PseudoClasses(FASharedPseudoclasses.s_pcNoBorder, FASharedPseudoclasses.s_pcBorderLeft,
    FASharedPseudoclasses.s_pcBorderRight, s_pcSingleBorder)]
...
public partial class FATabView
{
    ...
    public static readonly StyledProperty<bool> IsVerticalPaneOpenProperty =
        AvaloniaProperty.Register<FATabView, bool>(nameof(IsVerticalPaneOpen), true);
    ...
    public static readonly StyledProperty<double> VerticalOpenPaneLengthProperty =
        AvaloniaProperty.Register<FATabView, double>(nameof(VerticalOpenPaneLength), 225d);
    ...
    public static readonly StyledProperty<double> MinimumVerticalOpenPaneLengthProperty =
        AvaloniaProperty.Register<FATabView, double>(nameof(MinimumVerticalOpenPaneLength), 40d);
    ...
    public static readonly StyledProperty<double> MaximumVerticalOpenPaneLengthProperty =
        AvaloniaProperty.Register<FATabView, double>(nameof(MaximumVerticalOpenPaneLength), 700d);
    ...
    internal static readonly WeakEvent<FATabView, FATabViewTabDragStartingEventArgs> TabDragStartingWeakEvent =
        WeakEvent.Register<FATabView, FATabViewTabDragStartingEventArgs>((c, s) =>
        {
    ...
    internal static readonly WeakEvent<FATabView, FATabViewTabDragCompletedEventArgs> TabDragCompletedWeakEvent =
        WeakEvent.Register<FATabView, FATabViewTabDragCompletedEventArgs>((c, s) =>
        {
