...
public class FATaskDialogButton : FATaskDialogControl
{
    ...
    /// </summary>
    public static readonly FATaskDialogButton OKButton = new(FATaskDialogStandardResult.OK);

    /// <summary>
    ///     Predefined button for 'Cancel'. Note that predefined buttons cannot have command, icons,
    ///     or click handlers attached - they are meant for simple purposes
    /// </summary>
    public static readonly FATaskDialogButton CancelButton = new(FATaskDialogStandardResult.Cancel);

    /// <summary>
    ///     Predefined button for 'Yes'. Note that predefined buttons cannot have command, icons,
    ///     or click handlers attached - they are meant for simple purposes
    /// </summary>
    public static readonly FATaskDialogButton YesButton = new(FATaskDialogStandardResult.Yes);

    /// <summary>
    ///     Predefined button for 'No'. Note that predefined buttons cannot have command, icons,
    ///     or click handlers attached - they are meant for simple purposes
    /// </summary>
    public static readonly FATaskDialogButton NoButton = new(FATaskDialogStandardResult.No);

    /// <summary>
    ///     Predefined button for 'Retry'. Note that predefined buttons cannot have command, icons,
    ///     or click handlers attached - they are meant for simple purposes
    /// </summary>
    public static readonly FATaskDialogButton RetryButton = new(FATaskDialogStandardResult.Retry);
